...
public class PlayerController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        inputAction.Player.Move.performed += cntxt => Walker();
        inputAction.Player.Move.canceled += cntxt => move = Vector2.zero;
        inputAction.Player.Move.canceled += cntxt => NotWalker();
    ...
    public void ChangeJump(int potionpower)
    {
        jump += potionpower;
        Debug.Log(jump);
    }
